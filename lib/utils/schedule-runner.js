...
const { sendBlockedCommentEmails } = require('./emails/send-blocked-comment-emails');
...
function initSchedule() {
    ...
    schedule.scheduleJob('0 */1 * * * *', () => {
        return runSchedule('runScheduleForBlockedCommentEmails', sendBlockedCommentEmails);
    });
}
